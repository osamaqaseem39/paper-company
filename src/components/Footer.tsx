...
export default function Footer() {
  return (
    <footer className="bg-deep-indigo text-pure-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <Link href="#" className="text-cool-gray hover:text-pure-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/" className="text-cool-gray hover:text-pure-white transition-colors">Home</Link></li>
              <li><Link href="/services" className="text-cool-gray hover:text-pure-white transition-colors">Trading</Link></li>
              <li><Link href="/indenting" className="text-cool-gray hover:text-pure-white transition-colors">Indenting</Link></li>
              <li><Link href="/tender" className="text-cool-gray hover:text-pure-white transition-colors">Tender</Link></li>
              <li><Link href="/hp-paper" className="text-cool-gray hover:text-pure-white transition-colors">HP Paper Pakistan</Link></li>
              <li><Link href="/about" className="text-cool-gray hover:text-pure-white transition-colors">About Us</Link></li>
              <li><Link href="/contact" className="text-cool-gray hover:text-pure-white transition-colors">Contact</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-cool-gray/30 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="/privacy" className="text-cool-gray hover:text-pure-white text-sm transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-cool-gray hover:text-pure-white text-sm transition-colors">
                Terms of Service
              </Link>
            </div>
          </div>

...
export default async function Home() {
  ...
  // Get all brands from local data only - no API calls (show all on homepage)
  const brandsRes = await brandService.getActiveBrands(24, 1)
  const brands = brandsRes.success && brandsRes.data?.brands && brandsRes.data.brands.length > 0 
